...
const TareaState = props => {
    const initialState = {
        ...
        {id: 15, nombre: "Elegir Plataforma", estado: true, proyectoId: 1},
        {id: 16, nombre: "Elegir Colores", estado: false, proyectoId: 2},
        {id: 17, nombre: "Elegir Plataformas de pago", estado: false, proyectoId: 3},
    ],
      tareasproyecto: null,
      errortarea: false,
